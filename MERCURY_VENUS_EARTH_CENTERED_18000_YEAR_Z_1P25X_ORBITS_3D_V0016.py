# V0016
# Audit reference: BCE-safe JPL Horizons centered 3D orbit bundle with 1.25x-per-millennium Z-only exaggeration and minimal notebook output.
...
Z_PER_MILLENNIUM = 1.25
OUT = Path("/content/MERCURY_VENUS_EARTH_CENTERED_18000_YEAR_Z_1P25X_ORBITS_3D_V0016_OUTPUT")
PNG = OUT / "MERCURY_VENUS_EARTH_CENTERED_18000_YEAR_Z_1P25X_ORBITS_3D_V0016.png"
CSV = OUT / "MERCURY_VENUS_EARTH_CENTERED_18000_YEAR_Z_1P25X_ORBITS_3D_V0016.csv"
...
def make_plot(orbits: dict[str, list[dict]], summaries: list[dict]) -> None:
    ...
    ax.set_title(
        ...
        "Astronomical years −9000 to +9000; Z exaggerated 1.25× per millennium",
        color="white",
        fontsize=20,
        weight="bold",
        pad=30,
    ...
    info = [
        ...
        "Z factor: epoch 0 = 1×; each 1,000 years from zero adds 1.25×",
        "±1000→1.25×, ±5000→6.25×, ±9000→11.25×",
