...
Part W — Final flipped fine-line three-plane sphere geometry
...
VERSION = "IERS-0001-W"
OUTPUT_PNG = "IERS_0001_W_JPL_THREE_PLANE_SPHERE_FINAL.png"
OUTPUT_PDF = "IERS_0001_W_JPL_THREE_PLANE_SPHERE_FINAL.pdf"
...
def render(result: dict[str, object]) -> None:
    ...
    # Vertically mirrored orientation: Venus crosses left/up to right/down.
    ecliptic_angle = 0.0
    ...
    # Ecliptic label moved down-left and clear of the celestial label.
    axis.text(
        -1.08,
        -0.115,
        "ECLIPTIC PLANE",
    ...
    # Celestial label aligned with the dashed diameter.
    celestial_anchor = np.asarray(polar_xy(celestial_angle, -1.18))
    axis.text(
        celestial_anchor[0] - 0.02,
        celestial_anchor[1] + 0.005,
