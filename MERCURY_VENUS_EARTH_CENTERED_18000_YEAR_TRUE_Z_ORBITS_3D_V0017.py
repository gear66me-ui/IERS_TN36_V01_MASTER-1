# V0017
# Audit reference: standalone BCE-safe JPL Horizons centered 3D orbit bundle with true-scale Z and minimal notebook output.
...
Z_SCALE = 1.0
OUT = Path("/content/MERCURY_VENUS_EARTH_CENTERED_18000_YEAR_TRUE_Z_ORBITS_3D_V0017_OUTPUT")
PNG = OUT / "MERCURY_VENUS_EARTH_CENTERED_18000_YEAR_TRUE_Z_ORBITS_3D_V0017.png"
CSV = OUT / "MERCURY_VENUS_EARTH_CENTERED_18000_YEAR_TRUE_Z_ORBITS_3D_V0017.csv"
...
def make_plot(orbits: dict[str, list[dict]], summaries: list[dict]) -> None:
    ...
    ax.set_title(
        ...
        "Astronomical years −9000 to +9000; true-scale Z with no multiplication",
    ...
    ax.set_zlabel("Ecliptic Z (million km, true scale)", color="#E0E0E0", labelpad=12)
    ...
    info = [
        ...
        "X, Y, and Z all remain true scale",
        "Z factor = 1.00 for every epoch",
    ]
    fig.text(
