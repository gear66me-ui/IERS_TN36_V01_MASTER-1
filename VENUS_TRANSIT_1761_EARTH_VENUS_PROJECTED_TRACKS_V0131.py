# V0131
# Audit reference: 1761-only JPL geocentric plot with blue Earth orbit, green Venus orbit, white projected relative track, and right-to-left direction arrows.
...
def main() -> None:
    ...
    annotation = "\n".join([
        f"Earth orbit: {earth_track.positive_angle_deg:.6f}°",
    ...
    print(f"Earth orbit slope                    {result['earth_apparent_slope']:.9f}")
