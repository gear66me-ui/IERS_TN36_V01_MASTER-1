# IERS-0012U
# Audit reference: GitHubDelivery@IERS-0012U; preserve IERS-0012U JPL geometry and separate hourly/contact labels from the transit track.
...
VERSION = "IERS-0012U"
PROGRAM_NAME = "IERS_0012U_JPL_2004_NASA_FIGURE2_RECONSTRUCTION_LABEL_LAYOUT.py"
...
PNG_PATH = os.path.join(
    OUT_DIR,
    "IERS-0012U_JPL_2004_NASA_FIGURE2_RECONSTRUCTION.png",
)
CSV_PATH = os.path.join(
    OUT_DIR,
    "IERS-0012U_JPL_2004_NASA_FIGURE2_RECONSTRUCTION.csv",
)
...
def fetch_nasa_contact_table():
    ...
    try:
        request = urllib.request.Request(
            NASA_URL,
            headers={"User-Agent": "Mozilla/5.0 IERS-0012U"},
        )
...
def plot_reconstruction(
    ...
    for hour, state in hourly.items():
        ...
        offset_y = hourly_label_offsets[hour]
        axis.text(
            center[0],
            center[1] + offset_y,
            f"{hour:02d} UT",
...
def main():
    ...
    print("Contact and greatest-transit labels use separated up/down offsets with leader lines and dark backing boxes.")
    print("Hourly labels alternate above and below the track to avoid contact-label collisions.")
