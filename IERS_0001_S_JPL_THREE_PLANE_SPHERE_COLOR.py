...
Part S — Colored three-plane sphere geometry
...
VERSION = "IERS-0001-S"
OUTPUT_PNG = "IERS_0001_S_JPL_THREE_PLANE_SPHERE_COLOR.png"
OUTPUT_PDF = "IERS_0001_S_JPL_THREE_PLANE_SPHERE_COLOR.pdf"
...
def draw_rotation_arc(
    ...
    axis.plot(points[:, 0], points[:, 1], color=color, linewidth=1.8, zorder=6)
...
def render(result: dict[str, object]) -> None:
    ...
    draw_diameter(axis, ecliptic_angle, 1.12, COL_ECLIPTIC, 2.8, "-")
    draw_diameter(axis, celestial_angle, 1.12, COL_CELESTIAL, 2.3, "--")
    draw_diameter(axis, venus_angle, 1.12, COL_VENUS, 3.2, "-")

    axis.scatter([0.0], [0.0], s=36, color=COL_TEXT, zorder=9)
