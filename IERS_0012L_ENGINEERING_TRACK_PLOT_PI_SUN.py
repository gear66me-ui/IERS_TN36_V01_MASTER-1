# IERS-0012L
# Audit reference: GitHubDelivery@IERS-0012L; green/yellow tracks, lower-left table, corrected AB angular value.
...
VERSION = "IERS-0012L"
PROGRAM_NAME = "IERS_0012L_ENGINEERING_TRACK_PLOT_PI_SUN.py"
...
def add_summary_table_on_plot(ax, track_a, track_b, geometry):
    rows = [[q, fmt(v), u] for q, v, u in summary_rows(track_a, track_b, geometry)[:10]]
    table = ax.table(
        cellText=rows,
        colLabels=["Quantity", "Value", "Unit"],
        loc="lower left",
        colWidths=[0.29, 0.21, 0.16],
        bbox=[0.060, 0.118, 0.372, 0.352],
    )
