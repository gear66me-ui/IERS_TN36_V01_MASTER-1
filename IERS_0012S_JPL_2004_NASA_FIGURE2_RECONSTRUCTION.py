# IERS-0012S
# Audit reference: GitHubDelivery@IERS-0012S; JPL geocentric reconstruction of NASA Figure 2 for the 2004 Venus transit.
...
VERSION = "IERS-0012S"
PROGRAM_NAME = "IERS_0012S_JPL_2004_NASA_FIGURE2_RECONSTRUCTION.py"
...
PNG_PATH = os.path.join(
    OUT_DIR,
    "IERS-0012S_JPL_2004_NASA_FIGURE2_RECONSTRUCTION.png",
)
CSV_PATH = os.path.join(
    OUT_DIR,
    "IERS-0012S_JPL_2004_NASA_FIGURE2_RECONSTRUCTION.csv",
)
...
def fetch_nasa_contact_table():
    ...
    try:
        request = urllib.request.Request(
            NASA_URL,
            headers={"User-Agent": "Mozilla/5.0 IERS-0012S"},
        )
...
def main():
    ...
    print("Greatest-transit minimum                     : VERIFIED")
