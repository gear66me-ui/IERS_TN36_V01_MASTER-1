# V0152I
# Audit reference: preserve the approved V0152 reference plot and add only a red rho(t) parabola tangent to the white projected track at the locked closest-approach vertex.
...
OUT=Path("/content/VENUS_TRANSIT_1769_ECLIPTIC_CROSSHAIR_V0152I_OUTPUT")
PNG=OUT/"VENUS_TRANSIT_1769_ECLIPTIC_CROSSHAIR_V0152I.png"
...
def main():
    ...
    print("COMMENTS")
    print("Approved solar plot, three reference lines, callouts, legend, and angle box are preserved.")
    print("Only the former rho circle is replaced by the red +/-2-hour rho(t) parabola tangent to the white projected track at closest approach.")
    ...
    for text in legend.get_texts(): text.set_color("#E6E6E6")
    ...
    print("PASS: all three approved reference lines and callouts are retained; the red rho(t) parabola has its vertex at the locked closest approach and is tangent to the white projected track there.")
