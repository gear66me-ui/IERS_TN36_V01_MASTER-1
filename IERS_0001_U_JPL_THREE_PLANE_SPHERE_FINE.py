...
Part U — Fine-line colored three-plane sphere geometry
...
VERSION = "IERS-0001-U"
OUTPUT_PNG = "IERS_0001_U_JPL_THREE_PLANE_SPHERE_FINE.png"
OUTPUT_PDF = "IERS_0001_U_JPL_THREE_PLANE_SPHERE_FINE.pdf"
...
def render(result: dict[str, object]) -> None:
    ...
    # Ecliptic label: just left of the sphere, clear of the horizontal line.
    axis.text(
        -1.05,
        0.055,
        "ECLIPTIC PLANE",
    ...
    # Celestial label: aligned exactly with the dashed diameter and placed left of the sphere.
    celestial_anchor = np.asarray(polar_xy(celestial_angle, -1.10))
    axis.text(
        celestial_anchor[0] - 0.015,
        celestial_anchor[1],
