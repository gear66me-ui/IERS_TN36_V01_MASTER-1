# V0082
# Audit reference: Corrected geometric and astronomical audit table; removed raw 3D row and separate A′/B′ rows; reports one A′B′ value only.
...
def main() -> None:
    ...
    rows = [
        {
            "group": "distance",
            "quantity": "Reduced Earth-Venus distance",
            "symbol": "<span style='text-decoration:overline;'>EV</span>",
            "value": fmt(ev_bar),
            "unit": "km",
        },
        {
            "group": "distance",
            "quantity": "Reduced Venus-Sun distance",
            "symbol": "<span style='text-decoration:overline;'>VS</span>",
            "value": fmt(vs_bar),
            "unit": "km",
        },
        {
            "group": "distance",
            "quantity": "Reduced Earth-Sun distance",
            "symbol": "<span style='text-decoration:overline;'>ES</span>",
            "value": fmt(es_bar),
            "unit": "km",
        },
        {
            "group": "distance",
            "quantity": "Reduced distance closure",
            "symbol": "<span style='text-decoration:overline;'>EV</span> + <span style='text-decoration:overline;'>VS</span> − <span style='text-decoration:overline;'>ES</span>",
            "value": f"{reduced_closure:+.9f}",
            "unit": "km — PASS",
        },
        {
            "group": "geometry",
            "quantity": "A′B′ common-normal separation",
            "symbol": "A′B′",
            "value": fmt(float(geometry["A_prime_B_prime_arcsec"])),
            "unit": "arcsec",
        },
        {
            "group": "geometry",
            "quantity": "A′B′ common-normal separation",
            "symbol": "A′B′",
            "value": fmt(float(geometry["A_prime_B_prime_km"])),
            "unit": "km",
        },
        {
            "group": "geometry",
            "quantity": "AB projected baseline",
            "symbol": "AB",
            "value": fmt(float(geometry["AB_arcsec"])),
            "unit": "arcsec",
        },
        {
            "group": "geometry",
            "quantity": "AB projected baseline",
            "symbol": "AB",
            "value": fmt(float(geometry["AB_km"])),
            "unit": "km",
        },
        {
            "group": "final",
            "quantity": "Finite IAU 1976 solar horizontal parallax",
            "symbol": "π<sub>finite,IAU76</sub>",
            "value": fmt12(pi_finite_iau76),
            "unit": "arcsec",
        },
    ]
