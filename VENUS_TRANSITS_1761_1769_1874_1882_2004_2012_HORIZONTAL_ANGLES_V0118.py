# V0118
# Audit reference: six Venus-transit calendar-year plots with positive acute horizontal-axis angles, apparent track difference, and ecliptic angle sum.
...
VERSION = "V0118"
OUT = Path("/content/VENUS_TRANSITS_1761_1769_1874_1882_2004_2012_HORIZONTAL_ANGLES_V0118_OUTPUT")
CSV_NAME = "VENUS_TRANSITS_1761_1769_1874_1882_2004_2012_HORIZONTAL_ANGLES_V0118.csv"
...
PNG_NAMES = {
    year: f"VENUS_TRANSIT_{year}_HORIZONTAL_ANGLES_V0118.png"
...
def make_plot(
    ...
    x_offset_days = 18.0 if ca_date.month <= 8 else -18.0
    horizontal_alignment = "left" if x_offset_days > 0.0 else "right"
    y_offset = 0.12 * y_extent if ca_y <= 0.0 else -0.12 * y_extent
    vertical_alignment = "bottom" if y_offset > 0.0 else "top"
    ax.annotate(
        annotation,
        xy=(ca_date, ca_y),
...
def main() -> None:
    ...
    print("Each angle-data box is positioned beside its closest-approach transit point and linked by a thin leader line.")
